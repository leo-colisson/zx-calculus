...
\NewExpandableDocumentCommand{\zxBox}{O{}m}{
  ...
  \coordinate(fake center north) at (zxTmp.center);%
  \coordinate(fake center west) at (zxTmp.center);%
  \coordinate(fake center east) at (zxTmp.center);%  
  \coordinate(fake center south) at (zxTmp.center);%
}
