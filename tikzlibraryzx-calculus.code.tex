...
\zxNewNodeFromPic{Box}[
  ...
  \node[draw, inner sep=1.3mm, rectangle, fill=white, zx main node, execute at begin node=$, execute at end node=$,%alias=hello,
...
\NewExpandableDocumentCommand{\zxOCtrl}{O{}m}{%
  \node[zx main node, circle, inner sep=2pt, fill=white, draw, #1]{};
}

\NewExpandableDocumentCommand{\zxNot}{O{}m}{%
  \node[zx main node, circle, inner sep=2.5pt, draw, fill=white, append after command={(\tikzlastnode.north) edge (\tikzlastnode.south) (\tikzlastnode.east) edge (\tikzlastnode.west)}, #1]{};
}
...
\NewExpandableDocumentCommand{\zxCont}{O{}O{blue}mmO{}m}{%
  \zxExecuteAtEndPicture{%
    \zxNamedBox[#1][#2]{(\zxGetNameRelativeNode{0}{0})(\zxGetNameRelativeNode{\numexpr #3-1\relax}{\numexpr #4-1\relax})}[#5]{#6}%
  }%
}
