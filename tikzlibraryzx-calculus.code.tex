  ...
  \ifdefined\zxShouldUseIntersections%
    ...
    \ifcsname tikz@intersect@path@name@\tikz@intersect@path@a \endcsname%
      ...
      \pgfintersectionofpaths{%
        ...
        \pgfextractx{\pgf@xa}{\pgfpointdiff{\tikz@scan@one@point\pgf@process(#2)}{\pgfpointanchor{#1}{center}}}%
        \pgfextracty{\pgf@ya}{\pgfpointdiff{\tikz@scan@one@point\pgf@process(#2)}{\pgfpointanchor{#1}{center}}}%
        \pgfpathmoveto{\pgfpoint{-\pgf@xa}{\pgf@ya}}%
        %% What, now both axis are inverted??? If someone can explain me this...
        \pgfextractx{\pgf@xa}{\pgfpointdiff{\tikz@scan@one@point\pgf@process(#3)}{\pgfpointanchor{#1}{center}}}%
        \pgfextracty{\pgf@ya}{\pgfpointdiff{\tikz@scan@one@point\pgf@process(#3)}{\pgfpointanchor{#1}{center}}}%
