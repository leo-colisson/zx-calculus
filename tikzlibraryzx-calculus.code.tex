...
%%% of 90 for instance).
\NewDocumentCommand{\zxNewNodeFromPic}{mO{}O{}O{}m}{%
  \tikzset{%
    #1Pic/.pic={%
      % Code for the ground
      #5%
    ...
    #1/.style={%
      ...
      append after command={%
        ...
        zx create anchors={},
        % We load the other default arguments and per-instance arguments:
        #2, ##1, #3
        ]{#1Pic}%
      },
    }%
  ...
  \ExpandArgs{c}\NewExpandableDocumentCommand{zx#1}{t.t-t'O{}O{}m}{%
    |[#1={
      ...
      /utils/exec={%
        ...
        \IfBooleanT{##1}{\def\zxCurrentRotationMode{90}}%
        \IfBooleanT{##2}{\def\zxCurrentRotationMode{180}}%
        \IfBooleanT{##3}{\def\zxCurrentRotationMode{270}}%
      },
...
\NewExpandableDocumentCommand{\zxGround}{O{}m}{
  |[ground={#2},#1]| {}%
}

\NewExpandableDocumentCommand{\zxGroundCreate}{O{}m}{
  |[-ground={#2},#1]| {}%
}

\NewExpandableDocumentCommand{\zxGroundAbove}{O{}m}{
  |[ground',#1]| {}%
}

\NewExpandableDocumentCommand{\zxGroundBelow}{O{}m}{
  |[ground.,#1]| {}%
}
