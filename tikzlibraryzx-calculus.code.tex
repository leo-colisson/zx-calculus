...
\tikzset{
  /zx/wires definition/.style={
    ...
    start subnode/.code={%
      ...
      \ifcsname \zx@tmp\endcsname%
        \edef\tikzcd@ar@start{\csname zx@alias@\zxCurrentDiagram @\tikzcd@ar@start\endcsname ##1}%%
      \else%
      ...
      \ifcsname \zx@tmp\endcsname%
        \edef\tikzcd@ar@target{\csname zx@alias@\zxCurrentDiagram @\tikzcd@ar@target\endcsname ##1}%%
      \else%
