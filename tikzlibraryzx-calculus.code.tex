...
\tikzset{
  /zx/args/-andL/.cd,
  1-/.initial=\zxDefaultStraightO, %.2 by default
  2-/.initial=\zxDefaultStraightO,
  -/.style={
    1-=#1,
    2-=#1,
  },
  1L/.initial=\zxDefaultLO, % .4 by default
  2L/.initial=\zxDefaultLO,
  L/.style={
    1L=#1,
    2L=#1,
  },
...
\tikzset{
  /zx/wires definition/.style={
    ...
    % The dot versions are made for "left to right", and the others for up to down (possible to change)
    (/.style={
      start anchor=fake center west,
      bend right=##1},
    (/.default=30,
