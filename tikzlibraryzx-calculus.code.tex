...
\tikzset{
  ...
  /zx/defaultEnv/.style={
    nodes in empty cells=true, %% To avoid errors about single ampersand when matrix does not start with None.… Arg, but now it adds some spacing when a line starts with an empty node…
