...
\tikzset{
  /zx/wires definition/.style={
    ...
    3 vdots/.style={draw=none, "\makebox[0pt][r]{##1\,}\scalebox{\zxScaleDots}{$\cvdotsCenterMathline$}" {anchor=center,zxNormalFont}},
    3 vdots/.default={},
    3 vdotsr/.style={draw=none, "\makebox[0pt][l]{\ ##1}\scalebox{\zxScaleDots}{$\cvdotsCenterMathline$}" {anchor=center,zxNormalFont}},
    3 vdotsr/.default={},
    3 dots/.style={draw=none, "\makebox[0pt][r]{##1}\scalebox{\zxScaleDots}{$\chdots$}" {anchor=center,zxNormalFont}},
    3 dots/.default={},
  ...
  /zx/styles/rounded style/.style={
    ...
    ground/.style={
      ...
      append after command={
        pic[scale=\zxGroundScale,##1] {groundpic}
      },
    },
    ground-/.style={
      zxAllNodes,
    ...
    -ground/.style={
      ...
      shape=coordinate, % Otherwise the arrow will not point to the center
      append after command={
        pic[scale=\zxGroundScale,,rotate=180,##1] {groundpic}
      },
    },
    ground'/.style={
      zxAllNodes,
      shape=coordinate, % Otherwise the arrow will not point to the center
      append after command={
        pic[scale=\zxGroundScale,rotate=90,##1] {groundpic}
      },
    },
    ground./.style={
      zxAllNodes,
