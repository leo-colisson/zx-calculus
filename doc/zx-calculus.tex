...
\begin{command}{\zxZ\opt{\oarg{other styles}\oarg{*}\oarg{-}}\marg{text}}
...
\end{codeexample}
The |*| optional argument is to force a condensed style, no matter what is the text inside. You should use it very rarely (otherwise, change style directly).
\begin{codeexample}[width=3cm]
...
\begin{command}{\zxX\opt{\oarg{other styles}\oarg{*}\oarg{-}}\marg{text}}
