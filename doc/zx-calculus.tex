...
\begin{codeexample}[]
  \NewExpandableDocumentCommand{\mySimpleMultigate}{mmmm}{
    ...
    \zxExecuteAtCellRelative{0}{1}{\node[zx main node, #3]{\text{I am also relative}};}
...
\begin{codeexample}[]
  \NewExpandableDocumentCommand{\mySimpleMultigate}{mmm}{
    ...
    \zxSetVariable{my color}{#3}
    \zxExecuteAtCellRelative{1}{-1}{\node[tmp/.style/.expand once={\zxGetVariable{my color}}, tmp]{\text{\zxGetVariable{my variable}}};}
  }
  \begin{ZX}
A & B                                         & C  \\
  & \mySimpleMultigate{\alpha}{Alice}{purple} &  & \\
  &                                           &    \\
  \end{ZX}
\end{codeexample}
\end{pgfmanualentry}
