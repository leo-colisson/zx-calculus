...
\begin{stylekey}{/tikz/every node/a=alias}
  Shortcut to add an |alias| to a wire. Will be practical later when using names instead of direction to connect wires in order to improve readability and maintainability. This is added automatically in |/tikz/every node| style.
\begin{codeexample}[width=3cm]
  \begin{ZX}
